/*
 * ===================================================================
 * CANSAT EMISOR TODO-EN-UNO: BMP280 + LoRa DX-LR20 PARA ESP32
 * ===================================================================
 * Lee el sensor BMP280 por I2C y transmite los datos por LoRa.
 * 
 * Produce EXACTAMENTE el mismo formato de datos que el sistema
 * original, por lo que el receptor (lora_receptor.ino) y el 
 * dashboard Python funcionan sin ningun cambio.
 * 
 ...
 * 
 * CONEXIONES BMP280 (I2C por defecto ESP32):
 *   VCC  -> 3.3V
 *   GND  -> GND
 *   SDA  -> GPIO 21
 *   SCL  -> GPIO 22
 * 
 * CONEXIONES LoRa DX-LR20 (SPI Típico VSPI ESP32):
 *   VCC  -> 3.3V
 *   GND  -> GND
 *   SCK  -> GPIO 18
 *   MISO -> GPIO 19
 ...
 *   DIO1 -> GPIO 2
 *   BUSY -> GPIO 4
 *   RXEN -> GPIO 16 (Opcional según módulo)
 *   TXEN -> GPIO 17 (Opcional según módulo)
 * ===================================================================
 */
...
// ===================================================================
// CONFIGURACIÓN DE PINES LORA (ESP32)
// ===================================================================
#define LORA_NSS   5
#define LORA_DIO1  2
#define LORA_RST   14
...
// ISR para recepción de comandos (Específico de ESP32/ESP8266)
...
void setup() {
  ...
  if (state == RADIOLIB_ERR_NONE) {
    ...
    Serial.println(F("  Verifica conexiones SPI y pines en ESP32"));
  }
...
void loop() {
  ...
  if (loraOK) {
    ...
    // DESPUES de transmitir, volver a modo escucha
    radio.startReceive();
  } else {
